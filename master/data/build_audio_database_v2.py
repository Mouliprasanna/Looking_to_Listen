...
DATABASE_REPO_PATH = 'Looking-to-Listen-at-the-Cocktail-Party-master/data/AV_model_database'
FRAME_LOG_PATH = 'Looking-to-Listen-at-the-Cocktail-Party-master/data/video_data/valid_face_text.txt'
NUM_SPEAKER = 2
